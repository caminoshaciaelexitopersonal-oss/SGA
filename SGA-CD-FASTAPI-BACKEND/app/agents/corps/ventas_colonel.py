...
# --- Configuration ---
settings = Settings()
VECTOR_STORE_PATH = "app/agents/knowledge_base/faiss_index_sales"
...
def get_sales_agent_executor():
    ...
    if not os.path.exists(VECTOR_STORE_PATH):
        ...
        # Create a dummy retriever that returns an empty list of documents, wrapped in a RunnableLambda
