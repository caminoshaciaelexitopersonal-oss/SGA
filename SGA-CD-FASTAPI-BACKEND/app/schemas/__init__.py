...
from .curriculum import PlanCurricular, PlanCurricularCreate, PlanCurricularUpdate, PlanCurricularTema, PlanCurricularTemaCreate, PlanCurricularTemaUpdate, Disciplina, DisciplinaCreate, DisciplinaUpdate
